...
@router.get(
    ...
    summary="get single blog object",
)
...
@router.delete(
    "/delete/{id}", status_code=status.HTTP_204_NO_CONTENT, summary="delete post object"
)
